...
- [x] 1.3 Cover manual browser callback and device completion success paths with frontend tests.

## 2. Validation

- [x] 2.1 Run the targeted OAuth/account hook tests.
- [x] 2.2 Run frontend lint and typecheck.
- [ ] 2.3 Validate the OpenSpec change with `openspec validate invalidate-dashboard-after-oauth --strict`.
