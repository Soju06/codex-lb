...
The examples below default to `gpt-5.6-sol`. When present in your live catalog, use `gpt-5.6-terra` for balanced everyday work or `gpt-5.6-luna` for faster, lower-cost workloads.
