...
payload. When Astra continuation preparation on the client-facing dispatch
path inserts a reset, retain the original input count and fingerprint even
when no history trim is needed.
