...
- Code: `app/modules/proxy/service.py`, `app/db/alembic/versions/20260312_000000_add_additional_usage_quota_key.py`, `app/modules/usage/updater.py`
- Tests: `tests/unit/test_proxy_utils.py`, `tests/unit/test_db_migrate.py`, `tests/unit/test_usage_updater.py`
