## Implementation
- [x] Specify per-key defaults, catalog behavior, and client lifecycle.
- [x] Persist and expose the preference with migration coverage.
- [x] Add create/edit controls and translations.
- [x] Apply the native Astra catalog overlay without shared-metadata mutation.
