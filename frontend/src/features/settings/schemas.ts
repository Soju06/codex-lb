...
export const DashboardSettingsSchema = z
  .object({
    ...
    teamModeEnabled: z.boolean().optional().default(false),
    teamPublicBaseUrl: z.string().nullable().optional().default(null),
...
export const SettingsUpdateRequestSchema = z.object({
  ...
  teamModeEnabled: z.boolean().optional(),
  teamPublicBaseUrl: z.string().max(512).nullable().optional(),
