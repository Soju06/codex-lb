...
This developer command produces advisory measurements for [#1471](https://github.com/Soju06/codex-lb/issues/1471). Its contract is in the [migration-benchmark spec](specs/migration-benchmark/spec.md). It does not select a duration threshold, reference runner, CI trigger or maintenance-window policy.
