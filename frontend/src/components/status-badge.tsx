...
import type { AccountDisplayStatus } from "@/utils/account-status";

const statusClassMap: Record<AccountDisplayStatus, string> = {
  ...
  usageUnavailable: "bg-red-500/15 text-red-700 border-red-500/20 hover:bg-red-500/20 dark:text-red-400",
