...
- [x] 1.2 Add personality-specific wildcard aliases that win over the generic GPT-5 fallback

## 2. Regression coverage

- [x] 2.1 Add unit coverage for exact and suffixed GPT-5.6 pricing resolution
