...
def _stream_keepalive_max_count() -> int:
    """Preserve runtime overrides and bound parked-recovery keepalive tuning to the enabled mode."""
...
def _match_websocket_request_state_for_precreated_terminal_event(*args: Any, **kwargs: Any) -> Any:
    """Delegate identity-free terminal matching to the shared websocket request matcher."""
