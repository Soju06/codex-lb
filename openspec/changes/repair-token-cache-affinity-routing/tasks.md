...
- [ ] 4. Implement route wiring, affinity helper changes, header alias support, observability, Platform prompt-cache hit reuse, and derivation flag with minimal diffs.
