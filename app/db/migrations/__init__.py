...
from app.db.migrations.versions import (
    ...
    add_dashboard_settings_password,
...
MIGRATIONS: Final[tuple[Migration, ...]] = (
    ...
    Migration("007_add_dashboard_settings_password", add_dashboard_settings_password.run),
    Migration("008_add_api_keys", add_api_keys.run),
)
