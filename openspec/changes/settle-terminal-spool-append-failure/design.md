...
- [A grouped terminal fan-out can stall on its first fallback] -> Queue every sibling terminal event and end-of-stream marker before beginning their sequential persistence work, and defer cancellation until all pre-delivered siblings finish settlement and finalization.
