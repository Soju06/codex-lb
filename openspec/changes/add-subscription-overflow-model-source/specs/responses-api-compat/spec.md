...
- **THEN** the verdict is `portable`
- **WHEN** a declared stateless tool declaration carries `vector_store_ids`
- **THEN** the verdict is `not_portable_history`
