...
DEFAULT_PRICING_MODELS: dict[str, ModelPrice] = {
    ...
    "claude-opus-4.6": ModelPrice(input_per_1m=5.0, cached_input_per_1m=0.5, output_per_1m=25.0),
    "claude-opus-4.5": ModelPrice(input_per_1m=5.0, cached_input_per_1m=0.5, output_per_1m=25.0),
    "claude-opus-4.1": ModelPrice(input_per_1m=15.0, cached_input_per_1m=1.5, output_per_1m=75.0),
    "claude-opus-4": ModelPrice(input_per_1m=15.0, cached_input_per_1m=1.5, output_per_1m=75.0),
    "claude-sonnet-4.6": ModelPrice(input_per_1m=3.0, cached_input_per_1m=0.3, output_per_1m=15.0),
    "claude-sonnet-4.5": ModelPrice(input_per_1m=3.0, cached_input_per_1m=0.3, output_per_1m=15.0),
    ...
    "claude-haiku-4.5": ModelPrice(input_per_1m=1.0, cached_input_per_1m=0.1, output_per_1m=5.0),
    "claude-3-5-haiku": ModelPrice(input_per_1m=0.8, cached_input_per_1m=0.08, output_per_1m=4.0),
    "claude-haiku-3": ModelPrice(input_per_1m=0.25, cached_input_per_1m=0.03, output_per_1m=1.25),
}
...
DEFAULT_MODEL_ALIASES: dict[str, str] = {
    ...
    "anthropic2/claude-opus-4.6*": "claude-opus-4.6",
    "anthropic2/claude-opus-4-6*": "claude-opus-4.6",
    "anthropic2/claude-opus-4.5*": "claude-opus-4.5",
    "anthropic2/claude-opus-4-5*": "claude-opus-4.5",
    "anthropic2/claude-opus-4.1*": "claude-opus-4.1",
    "anthropic2/claude-opus-4-1*": "claude-opus-4.1",
    "anthropic2/claude-opus-4*": "claude-opus-4",
    "anthropic2/claude-sonnet-4.6*": "claude-sonnet-4.6",
    "anthropic2/claude-sonnet-4-6*": "claude-sonnet-4.6",
    "anthropic2/claude-sonnet-4.5*": "claude-sonnet-4.5",
    "anthropic2/claude-sonnet-4-5*": "claude-sonnet-4.5",
    "anthropic2/claude-sonnet-4*": "claude-sonnet-4",
    "anthropic2/claude-3-7-sonnet*": "claude-3-7-sonnet",
    "anthropic2/claude-haiku-4.5*": "claude-haiku-4.5",
    "anthropic2/claude-haiku-4-5*": "claude-haiku-4.5",
    "anthropic2/claude-3-5-haiku*": "claude-3-5-haiku",
}
