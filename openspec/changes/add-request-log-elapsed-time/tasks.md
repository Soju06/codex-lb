...
- [x] 2.2 Add frontend coverage for elapsed-time formatting and `elapsed (latency)` rendering
...
- [x] 3.3 Show `Elapsed Time` in the Request Details dialog as formatted elapsed plus dimmed latency text
