...
- [x] Integrate upstream `d1fd2f21`, preserving early HTTP response ownership, affinity observations and the existing context contract.
- [x] Join the deployed context head with the OIDC migration head without rewriting applied revisions.
- [x] Verify old context and fresh upstream upgrade paths, including the intentional removal of the legacy dashboard credential mirror.
