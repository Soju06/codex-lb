...
class DurableBridgeSessionCoordinator:
    ...
    async def lookup_request_targets(
        ...
        *,
        ...
        """Resolve scoped durable session and alias targets for the request's continuity hints."""
        ...
        async with self._session() as session:
            ...
            for alias_kind, alias_value in (
                ...
                if snapshot is not None:
                    if durable_bridge_snapshot_is_detached(snapshot):
                        continue
    ...
    async def rebind_operation_for_complete_transcript(
        ...
        *,
        ...
        rebind_claim_id: str | None = None,
    ) -> DurableBridgeOperationSnapshot | None:
        """Claim a fenced transcript rebind through an isolated repository session, or return None."""
        async with self._session() as session:
    ...
    async def get_replayable_transcript(
        ...
        *,
        ...
        """Load a bounded replayable response chain using a session owned by this call."""
        async with self._session() as session:
    ...
    async def get_complete_transcript(
        ...
        *,
        ...
        """Load complete response history within turn, byte, and optional API-key scope bounds."""
        async with self._session() as session:
    ...
    async def update_operation(
        ...
        *,
        ...
        """Persist fenced operation state and optional transcript snapshots in a dedicated session."""
        async with self._session() as session:
    ...
    async def rollback_operation_before_dispatch(
        ...
        *,
        ...
        """Compensate an undispatched claim without overwriting a different owner or recovery generation."""
        async with self._session() as session:
    ...
    async def get_unique_unknown_operation_for_latest_parent(
        ...
        *,
        ...
        """Find the sole scoped unknown operation attached to the session's latest completed parent."""
        async with self._session() as session:
    ...
    async def get_unique_unknown_operation_for_root(
        ...
        *,
        ...
        """Find the sole scoped parentless unknown operation for the session and model."""
        async with self._session() as session:
    ...
    async def get_recent_unknown_operations(
        ...
        *,
        ...
        """Fetch scoped recovery candidates with explicit age and result-count bounds."""
        async with self._session() as session:
    ...
    async def register_previous_response_id(
        ...
        *,
        ...
        """Register an owned response alias, requiring a durable target for retained replay aliases."""
