...
async def _validate_identity_uncached(
    *,
    ...
    validation_account_id: str
    validation_route: ResolvedUpstreamRoute | None
...
async def _resolve_route(session: AsyncSession, account_id: str) -> ResolvedUpstreamRoute | None:
    try:
