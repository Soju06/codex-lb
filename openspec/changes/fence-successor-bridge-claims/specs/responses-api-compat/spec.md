...
- **WHEN** the stale creator finishes claiming and fails to register
- **THEN** it closes its own session without releasing the durable row
- **AND** the registered session keeps a live durable row
