        ...
        *,
        ...
        try:
            with anyio.fail_after(remaining_budget):
                settings = await get_settings_cache().get()
                sticky_reallocation_budget_threshold_pct = getattr(
                    settings, "sticky_reallocation_budget_threshold_pct", 95.0
                )
                ...
                if preferred_account_selectable:
                    ...
                    preferred_selection = await self._load_balancer.select_account(
                        ...
                        budget_threshold_pct=sticky_reallocation_budget_threshold_pct,
