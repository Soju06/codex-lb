...
- Frontend: sticky-session table selection state, filter and sort controls, bulk action controls, confirmation UX, refresh behavior
- Tests: backend sticky-session list query coverage plus frontend filter/sort and bulk-delete interaction coverage
