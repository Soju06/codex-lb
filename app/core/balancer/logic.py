...
def _reset_drain_sort_key(state: AccountState, current: float) -> tuple[bool, float, float, float, str, str]:
    ...
    exhausted = primary_remaining <= 0.0 or secondary_remaining <= 0.0
    return (
        exhausted,
        reset_at,
