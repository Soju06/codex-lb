...
export function buildSettingsUpdateRequest(
  ...
  const payload: SettingsUpdateRequest = {
    ...
    proxyAccountResponseCreateLimit: settings.proxyAccountResponseCreateLimit,
    proxyAccountStreamLimit: settings.proxyAccountStreamLimit,
    proxyAccountStreamRecoveryReserve: settings.proxyAccountStreamRecoveryReserve,
