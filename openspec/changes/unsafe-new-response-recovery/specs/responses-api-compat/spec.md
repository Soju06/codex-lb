...
the code is absent), including the exact terse invalid-anchor message.
Other upstream rejections MUST NOT trigger unsafe fresh-response recovery. The request MUST
