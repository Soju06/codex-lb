...
from app.core.exceptions import ProxyInvalidRequestError
from tests.unit.test_astra_protocol import (
    ScriptedSocket,
    ScriptedUpstream,
    create,
    response,
...
@pytest.mark.asyncio
@pytest.mark.parametrize("error", [ValueError("private-value"), ProxyInvalidRequestError("private-value")])
