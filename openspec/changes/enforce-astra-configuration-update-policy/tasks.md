...
- [x] 3.21 Preserve conversation-anchored client prefix metadata on streaming and collected bridge routes; keep conversation removal scoped to Astra policy reconstruction
