...
This bounded parked-candidate search MUST supplement the existing exact root
and latest-parent UNKNOWN probes. Enabling parked recovery MUST NOT disable
the existing root UNKNOWN recovery path.
