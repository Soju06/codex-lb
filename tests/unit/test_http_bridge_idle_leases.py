...
def _expected_concurrency_caps() -> proxy_service.AccountConcurrencyCaps:
    return proxy_service.effective_account_concurrency_caps(proxy_service.get_settings())
...
async def test_next_turn_reacquires_stream_lease() -> None:
    ...
    fake_self._load_balancer.acquire_account_lease.assert_awaited_once_with(
        ...
        concurrency_caps=_expected_concurrency_caps(),
    )
