...
## Purpose
Communicate the running application version on HTTP 2xx–4xx responses, including handled client errors, while omitting the header from server failures and WebSocket traffic.
## Requirements
