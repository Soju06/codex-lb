...
| `CODEX_LB_HTTP_RESPONSES_SESSION_BRIDGE_COMPLETE_TRANSCRIPT_MAX_BYTES` | T4 | `int` | `8388608` |
| `CODEX_LB_HTTP_RESPONSES_SESSION_BRIDGE_COMPLETE_TRANSCRIPT_MAX_INPUT_ITEMS` | T4 | `int` | `4096` |
| `CODEX_LB_HTTP_RESPONSES_SESSION_BRIDGE_COMPLETE_TRANSCRIPT_MAX_TURNS` | T4 | `int` | `256` |
| `CODEX_LB_HTTP_RESPONSES_SESSION_BRIDGE_COMPLETE_TRANSCRIPT_RECOVERY_ENABLED` | T4 | `bool` | `False` |
...
| `CODEX_LB_HTTP_RESPONSES_SESSION_BRIDGE_PARKED_RECOVERY_ENABLED` | T4 | `bool` | `False` |
| `CODEX_LB_HTTP_RESPONSES_SESSION_BRIDGE_PARKED_RECOVERY_RECENT_UNKNOWN_LIMIT` | T4 | `int` | `8` |
| `CODEX_LB_HTTP_RESPONSES_SESSION_BRIDGE_PARKED_RECOVERY_RECENT_UNKNOWN_MAX_AGE_SECONDS` | T4 | `float` | `900` |
| `CODEX_LB_HTTP_RESPONSES_SESSION_BRIDGE_PRE_RESPONSE_KEEPALIVE_MAX_COUNT` | T4 | `int` | `6` |
...
| `CODEX_LB_HTTP_RESPONSES_SESSION_BRIDGE_UNSAFE_NEW_RESPONSE_RECOVERY_ENABLED` | T4 | `bool` | `False` |
| `CODEX_LB_HTTP_RESPONSES_SESSION_BRIDGE_UNSAFE_PARTIAL_REPLAY_ENABLED` | T4 | `bool` | `False` |
