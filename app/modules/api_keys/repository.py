...
class ApiKeysRepository:
    ...
    async def update(
        ...
        *,
        ...
        omit_priority_request: bool | _Unset = _UNSET,
        ...
        if omit_priority_request is not _UNSET:
            assert isinstance(omit_priority_request, bool)
            row.omit_priority_request = omit_priority_request
