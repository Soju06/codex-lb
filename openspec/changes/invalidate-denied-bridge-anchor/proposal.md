...
- Carry tombstones across live same-key generations: publish to an already-installed successor and inherit from detached predecessors during registration, so an owner-epoch advance cannot fence cleanup and revive the denied id.
