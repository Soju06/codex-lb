...
async def test_http_bridge_pre_response_silence_is_bridge_eventless_timeout(
    ...
    from app.core.openai.models import OpenAIError as _OpenAIError
    from app.modules.proxy import api as proxy_api_module

    assert proxy_api_module._status_for_error(_OpenAIError(code="bridge_eventless_timeout")) == 503
