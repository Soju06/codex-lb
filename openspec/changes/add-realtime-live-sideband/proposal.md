...
- Require a registered proxy API key for private realtime call creation and sideband attachment, independently of the global ordinary-proxy auth toggle.
