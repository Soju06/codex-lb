...
- **AND** no token request is issued
...
- **WHEN** the Settings page renders
- **THEN** the collapsed line says that accounts are added and removed automatically, does not claim that password sign-in is restricted, and still contains none of the banned words
