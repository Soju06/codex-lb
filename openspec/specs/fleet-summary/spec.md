...
## Purpose
Expose authenticated fleet-level operational summaries covering quota pressure, sticky continuity, and replica-safe observability without sensitive data.
## Requirements
