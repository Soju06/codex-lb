...
describe("formatters", () => {
  ...
  it("formats conversation durations as two units", () => {
    expect(formatConversationDuration("2026-01-01T00:00:00.000Z", "2026-01-01T00:00:00.000Z")).toBe("0m");
    expect(formatConversationDuration("2026-01-01T00:00:00.000Z", "2026-01-01T00:00:01.000Z")).toBe("0m");
    ...
    expect(formatConversationDuration("2026-01-01T02:00:00.000Z", "2026-01-01T01:00:00.000Z")).toBe("0m");
