...
- [Library wording could change] → Pin direct detection to the concrete close code/reason emitted by the installed `websockets` API and cover both adapters with regression tests.
