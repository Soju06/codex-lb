...
- **GIVEN** a successful `normal` sol row with 60000 input tokens, reasoning effort `high`, 400 output tokens, 2000 ms first-token latency and 12000 ms total latency, no queue wait and a single send
- **WHEN** the row is written
