...
export const AccountSummarySchema = z.object({
  ...
  rateLimitResetAvailableCount: z.number().int().nullable().optional(),
...
export const AccountUsageResetResponseSchema = z.object({
  status: z.string(),
  accountId: z.string(),
  consumeCode: z.string(),
  windowsReset: z.number().int().nullable().optional(),
  rateLimitResetAvailableCountBefore: z.number().int().nullable(),
  rateLimitResetAvailableCountAfter: z.number().int().nullable(),
  primaryUsedPercentBefore: z.number().nullable(),
  primaryUsedPercentAfter: z.number().nullable(),
  secondaryUsedPercentBefore: z.number().nullable(),
  secondaryUsedPercentAfter: z.number().nullable(),
