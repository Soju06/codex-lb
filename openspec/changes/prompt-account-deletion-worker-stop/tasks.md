...
- [x] 1.1 Reproduce the stall deterministically: a tick body that swallows the stop cancellation leaves `stop()` blocked at `deletion.py:482` for the whole interval.
