...
## Purpose
Select upstream accounts predictably across availability, quota, health, stickiness, and routing-strategy constraints while preserving account ownership boundaries.
## Requirements
