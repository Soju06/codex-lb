...
def _account_selection_recovery_sleep_seconds(selection: AccountSelection) -> float | None:
    # A capacity wait cannot authorize an out-of-scope hard owner. Keep the
    # established terminal mapping instead of timing out on impossible retries.
    if selection.hard_affinity_scope_mismatch:
        return None
