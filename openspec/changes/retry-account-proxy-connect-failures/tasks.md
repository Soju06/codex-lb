...
- [x] Move a locally verified complete fresh replay off a dead previous-response owner on raw HTTP/SSE without overriding other hard ownership or widening native WebSocket/HTTP bridge replay gates.
